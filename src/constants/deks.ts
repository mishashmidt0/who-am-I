...
export const CARD_DECKS_ARR: CardDecksArrType = [
  ...
  {id: 0, name: 'Герои мультфильмов', imgSrc: './image/img/cartoons/cartoonsDeck.jpeg', cardsArr:
    [
  ...
  {id: 0, name: 'Профессии', imgSrc: './image/img/professions/professionsDeck.jpg', cardsArr:
    [
